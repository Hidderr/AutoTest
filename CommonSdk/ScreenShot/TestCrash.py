...
class case_01(unittest.TestCase):
    ...
    def test_case2(self):
        """ 手机QQ截图"""
        title = self.driver.find_element_by_id("com.xgimi.instruction30:id/tv1")
        title.click()
        # self.driver.get
        # self.add_img()
        # self.add_img()
...
if __name__ == "__main__":
    ...
    runer = HTMLTestRunner(title="带截图的测试报告", description="测试描述", stream=open("电子crash5.html", "wb"), verbosity=2, retry=1, save_last_try=True)
    runer.run(suiteAll)
